# Functional Python [![](https://github.com/WasabiWabiSabi/functional-python/workflows/tests/badge.svg)](https://github.com/WasabiWabiSabi/functional-python/actions?query=workflow%3Atests)
